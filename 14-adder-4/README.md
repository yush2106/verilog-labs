...
The 4 bit full adder can do the addition which includes input parameters A, B and carry in. The output parameters are summation number and carry out.
...
assign sum = temp[3:0];    //summation number
